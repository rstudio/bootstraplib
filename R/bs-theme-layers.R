...
#' higher-level theme customization functions (e.g., [bs_base_colors()], etc),
#' these functions are a more direct interface to Bootstrap Sass, and therefore,
#' do nothing to ensure the theme customization you add are portable between
#' major Bootstrap versions.
#'
...
#' theme <- bs_add_rules(sass::sass_file(person_rules))
