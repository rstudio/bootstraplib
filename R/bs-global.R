...
#' defaults to `bs_global_get()`, which get the current global theme). Once a
#' global theme has been created, theme customization may be added via
#' 'high-level' (e.g., [bs_base_colors()])
...
#' bs_global_theme(3)
#' bs_global_base_colors(bg = "#444", fg = "#e4e4e4")
#' bs_global_accent_colors(primary = "#e39777")
